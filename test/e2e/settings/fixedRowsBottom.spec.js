  ...
  describe('fixedRowsBottom', () => {
    ...
    describe('should display synchronized layers', () => {
      it('when table\'s height is not set by settings', () => {
        ...
        expect(getBottomLeftClone().find('th').eq(0)[0].getBoundingClientRect().left).toEqual(thLeft);
        expect(getBottomLeftClone().find('th').eq(0)[0].getBoundingClientRect().bottom).toEqual(thBottom);
      });
